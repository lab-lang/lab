...
pub const SERIAL_DILUTION: &str = "https://www.lab-compiler.org/ns/procedure#SeriallyDiluteCulture";
pub const CYCLE_GOLDEN_GATE: &str =
    "https://www.lab-compiler.org/ns/procedure#ThermalCycleGoldenGateReaction";
pub const PREPARE_CHEMICAL_TRANSFORMATION: &str =
    "https://www.lab-compiler.org/ns/procedure#PrepareChemicalTransformation";
pub const HEAT_SHOCK_TRANSFORMATION: &str =
    "https://www.lab-compiler.org/ns/procedure#HeatShockTransformation";
pub const ADD_RECOVERY_MEDIUM: &str = "https://www.lab-compiler.org/ns/procedure#AddRecoveryMedium";
pub const INCUBATE_RECOVERY_CULTURE: &str =
    "https://www.lab-compiler.org/ns/procedure#IncubateRecoveryCulture";
pub const PLATE_DILUTED_CULTURE: &str =
