...
pub(in crate::backend::opentrons_ot2) fn render_assembly_protocol(
    plan: &Ot2ExecutionPlan,
) -> Result<String, Ot2EmissionError> {
    render_protocol("assembly", ASSEMBLY_SOURCE, plan)
}

pub(in crate::backend::opentrons_ot2) fn render_transformation_protocol(
    plan: &Ot2ExecutionPlan,
) -> Result<String, Ot2EmissionError> {
    render_protocol("transformation", TRANSFORMATION_SOURCE, plan)
}

pub(in crate::backend::opentrons_ot2) fn render_plating_protocol(
    plan: &Ot2ExecutionPlan,
) -> Result<String, Ot2EmissionError> {
