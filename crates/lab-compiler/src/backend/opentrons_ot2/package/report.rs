//! Human- and machine-readable rendering of a dependency-driven build.
...
use super::compile::DependencyBuildError;

pub(super) fn render_full_build_instructions(
...
pub(super) fn render_report(manifest: &DependencyBuildManifest) -> String {
    let mut output = String::new();
...
pub(super) fn pretty_json(value: &impl Serialize) -> Result<String, DependencyBuildError> {
