...
- `src/backend/` defines backend contracts and contains the concrete backends, grouped by vendor family: `opentrons/ot2/`, `opentrons/flex/`, `hamilton/star/`, and `workcell/`, which composes stations;
