...
pub use manifest::{
    ...
    InventoryMetadata, LabManifest, MethodPinMetadata, PackageManifest, PackageMetadata,
    PlanningAdapterRequirement, PlanningMetadata, WorkspaceManifest, WorkspaceMetadata,
};
pub use package::{
