...
The durable planning problem, policy and solution records, exact MaterialLot evidence, and allocated LAIR remain owned by `lab-lair`. Concrete adapter implementations and immutable adapter-invocation records are owned by `lab-adapters`; this crate joins them to facility inventory and planning evidence.
