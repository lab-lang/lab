...
The durable planning problem, policy and solution records, exact MaterialLot evidence, and allocated LAIR remain owned by `lab-lair`. Concrete adapter implementations and immutable adapter-invocation records also remain there temporarily while the adapter package is extracted.
