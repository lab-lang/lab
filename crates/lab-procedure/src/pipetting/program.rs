...
pub(super) mod test_support {
    ...
    pub(in crate::pipetting) fn id(value: &str) -> ProcedureLocalId {
        ProcedureLocalId::new(value).unwrap()
    }

    pub(in crate::pipetting) fn location(vessel: &str, position: u32) -> Location {
        Location {
            vessel: id(vessel),
            position,
        }
    ...
    pub(in crate::pipetting) fn example() -> PipettingProgramV1 {
