...
This frontend analysis complements SSA material-linearity analysis in Allocated Procedure LAIR. The frontend pass reasons about source workflow control flow before refinement, refined-alternatives LAIR verifies material use within every candidate region, and allocated-procedure LAIR verifies the selected concrete SSA consumers before adapter invocation.
