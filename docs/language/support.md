...
| Action capability and ownership contracts | n/a | built-ins | absolute SBOLInventory capability IRI and ownership modes | `lab.portable-module.v6` plus `lab.capability-requirements.v1` templates | facility binding pending |
